...
`.github/workflows/build-android-apk.yml`은 `game` 변경이 `main`에 반영될 때 ARM64 디버그 APK를 생성한다. 현재 결과물 이름은 `happiness-tale-cp102-facing-input-fix-apk`이며 APK와 SHA-256 파일을 14일간 보관한다.
